...
motor PickupMotorA = motor(PORT11, ratio18_1, false);
motor PickupMotorB = motor(PORT12, ratio18_1, false);
motor_group Pickup = motor_group(PickupMotorA, PickupMotorB);
